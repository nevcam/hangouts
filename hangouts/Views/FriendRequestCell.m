...
- (void)awakeFromNib {
    ...
    _acceptButton.backgroundColor = [UIColor colorWithRed:0.77 green:0.60 blue:0.91 alpha:1.0];
    _denyButton.backgroundColor = [UIColor colorWithRed:0.85 green:0.84 blue:0.84 alpha:1.0];
